...
<div class="card shadow-lg p-4" style="width: 350px;">
    ...
    <form action="update" method="post">
        <div class="md-3">
            ...
            <input type="text" class="form-control" name="fName" value= "${dto.getFName()}">
            <label form="form-label">Last Name</label>
            <input type="text" class="form-control" name="lName" value = "${dto.getLName() }">
            <label form="form-label">Travel Date</label>
            <input type="date" class="form-control" name="dob" value= "${dto.getDob()}">
            ...
            <input type="text" class="form-control" name="num" value = "${dto.getNum()}">
        </div>
        <div class="md-3">
